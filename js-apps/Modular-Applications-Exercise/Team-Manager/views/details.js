...
import { teams } from '../requests/req.js'
import { pageLayout } from '../components/layout.js'
import { contextAPI } from '../src/api.js'
...
const joinTeam = async (context, e) => {
	...
	render(pageLayout(detailsTemp(updatedContext)), document.getElementById('content'))
}
...
const detailsTemp = context => html`
