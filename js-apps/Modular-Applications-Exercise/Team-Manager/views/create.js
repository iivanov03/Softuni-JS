...
import { teams, user } from '../requests/req.js'
...
const create = async (e) => {
	...
	try {
		...
		render(pageLayout(createTemp(errors[error.message])), document.getElementById('content'))
	}
}

const createTemp = (context, errorMsg) => html`
    <section id="create">
...
export { createTemp as createTemp }