...
import { cars } from '../requests/req.js'
import page from '../node_modules/page/page.mjs'

const editListing = async (id, e) => {
	e.preventDefault()
...
const editTemp = ({ _id, _ownerId, brand, model, year, price, description, imageUrl }) => {

	return html`
        <section id="edit-listing">
            <div class="container">
                <form id="edit-form" @submit="${(e) => editListing(_id, e)}">
