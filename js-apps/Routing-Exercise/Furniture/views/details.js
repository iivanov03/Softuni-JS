...
import { furniture } from '../requests/req.js'
import page from '//unpkg.com/page/page.mjs'
import { fetches } from '../requests/httpHelper.js'

const deleteFurniture = async (id) => {
    let confirmed = confirm('Are you sure you want to delete this?');
    if(confirmed){
        let deleteResult = await fetches.delete(id);
        page.redirect('/details/${id}', '/dashboard');
    }
